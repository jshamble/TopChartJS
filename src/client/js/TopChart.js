...
import * as d3 from 'd3'; // npm install d3 // https://code.likeagirl.io/how-to-set-up-d3-js-with-webpack-and-babel-7bd3f5e20df7

var css = require.context("../css", true, /^(.*\.(css$))[^.]*$/im);
css.keys().forEach(function(key){
    css(key);
});
